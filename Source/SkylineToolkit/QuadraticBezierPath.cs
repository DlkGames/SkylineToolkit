...
namespace SkylineToolkit
{
    ...
    /// </summary>
    [Serializable]
    public class QuadraticBezierPath : IEnumerable<QuadraticBezier3>, IEnumerable<Vector3>
    {
        ...
        public Vector3[] Points
        {
            ...
            private set
            {
                if (value.Length < 3 || (value.Length - 1) % 2 != 0)
                {
        ...
        public Vector3[] BezierPoints
        {
            get
            {
                ...
                return this.points.Where((vec, index) => index == 0 || index % 2 == 0).ToArray();
            }
        }
        ...
        /// </summary>
        public QuadraticBezier3[] Beziers
        {
            get
            {
                if (this.points.Count < 3)
                {
                    return new QuadraticBezier3[0];
                }
                ...
                return this.BezierPoints
                    ...
                    .Select((bp, index) => new QuadraticBezier3(bp, handlePoints[2 * index], bezierPoints[index + 1]))
                    .ToArray();
            }
        }
        ...
        public QuadraticBezier3 GetBezierAt(int index)
        {
            ...
            return new QuadraticBezier3(this.points[2 * index], this.points[2 * index + 1], this.points[2 * index + 2]);
        }
        ...
        public void SetBezierAt(int index, QuadraticBezier3 bezier)
        {
            if (index > this.BezierCount - 1)
            {
                throw new ArgumentOutOfRangeException("index");
            ...
            this.points[2 * index] = bezier.p0;
            this.points[2 * index + 1] = bezier.p1;
            this.points[2 * index + 2] = bezier.p2;
        }
        ...
        public void AddBezier(QuadraticBezier3 bezier)
        {
        ...
        public void AddBezier(QuadraticBezier3 bezier, bool interpolateBetween)
        {
            if (this.points.Count == 0)
            {
                this.points.AddRange(new Vector3[] {
        ...
        public void InsertBezier(int index, QuadraticBezier3 bezier)
        {
            if (index > this.BezierCount - 1)
            {
                throw new ArgumentOutOfRangeException("index");
        ...
        public void RemoveBezier(int index)
        {
            ...
            this.points.RemoveRange(pointIndex, 2);
        }
        ...
        {
            if (this.points.Count < 3 || (this.points.Count - 1) % 2 != 0)
            {
                return;
            }
        ...
        public IEnumerable<Vector3> GetDrawingPoints(int segmentsPerBezier)
        {
            ...
            QuadraticBezier3[] beziers = this.Beziers;

            for (int i = 0; i < this.BezierCount; i++)
            {
                QuadraticBezier3 bezier = beziers[i];
        ...
        private IEnumerable<Vector3> FindDrawingPoints(QuadraticBezier3 bezier, float minSquareDistance, float divisionThreshold)
        {
        ...
        private int FindDrawingPoints(QuadraticBezier3 bezier, float t0, float t1, List<Vector3> pointList, int insertionIndex)
        {
        ...
        public IEnumerator<QuadraticBezier3> GetEnumerator()
        {
            for (int i = 0; i < this.BezierCount; i++)
            {

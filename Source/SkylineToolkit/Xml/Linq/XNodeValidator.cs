...
// Changed namespace to prevent conflict with original SkylineToolkit.Xml.Linq
namespace SkylineToolkit.Xml.Schema
{
        ...
        public void Validate(XObject source, XmlSchemaObject partialValidationType, bool addSchemaInfo)
        {
            ...
            switch (nt)
            {
                case XmlNodeType.Document:
                    ...
                    if (source == null) throw new InvalidOperationException(SkylineToolkit.Xml.Linq.Res.GetString(SkylineToolkit.Xml.Linq.Res.InvalidOperation_MissingRoot));
                ...
                case XmlNodeType.Attribute:
                    ...
                    if (source.Parent == null) throw new InvalidOperationException(SkylineToolkit.Xml.Linq.Res.GetString(SkylineToolkit.Xml.Linq.Res.InvalidOperation_MissingParent));
                    break;
                default:
                    throw new InvalidOperationException(SkylineToolkit.Xml.Linq.Res.GetString(SkylineToolkit.Xml.Linq.Res.InvalidOperation_BadNodeType, nt));
            }
